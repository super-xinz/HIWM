import type { ClientObservationPayload } from '@/store/perception'
import type { ClientSessionProfilePayload } from '@/store/profile'
...
export enum WsProtocol {
  ...
  SendClientObservation = 'SendClientObservation',
  SendSessionProfile = 'SendSessionProfile',
...
export type WsPayloadMap = {
  ...
  [WsProtocol.SendClientObservation]: ClientObservationPayload
  [WsProtocol.SendSessionProfile]: ClientSessionProfilePayload
...
export type WsOutboundMessage = WsMessage<
  ...
  | WsProtocol.SendClientObservation
  | WsProtocol.SendSessionProfile
